...
int main(){ 
  ...
  vars.push_back(hfeats("fjets_m[0]",75,65,140, dy_sam, "m(J_{1}) [GeV]", "1"));
  ...
  vars.push_back(hfeats("fjets_m[0]",20,0,500, ra4_sam, "m(J_{1}) [GeV]",
			"pass&&ht>400&&(nmus>=2||nels>=2)&&njets>=2&&"+mll));
  ...
  vars.push_back(hfeats("fjets_m[0]",20,0,500, ra4_sam, "m(J_{1}) [GeV]",
			"pass&&ht>400&&(nmus>=2||nels>=2)&&njets==3&&"+mll));
  vars.back().whichPlots = "12"; vars.back().normalize = true;
  ...
  vars.push_back(hfeats("fjets_m[0]",20,0,500, ra4_sam, "m(J_{1}) [GeV]",
			"pass&&ht>400&&(nmus>=2||nels>=2)&&njets==4&&"+mll));
  vars.back().whichPlots = "12"; vars.back().normalize = true;

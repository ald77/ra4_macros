...
int main(){ 
  ...
  TString foldermc("/cms2r0/babymaker/babies/2015_11_28/mc/bkg/skim_1lht500met200/");
  ...
  vars.push_back(hfeats("mj",12,0,1200, ra4_sam, "M_{J} [GeV]","nleps==1&&ht>500&&met>200&&njets>=6&&nbm>=1"));
  vars.back().whichPlots = "12"; vars.back().normalize = true;
  vars.push_back(hfeats("mt",18,0,630, ra4_sam, "m_{T} [GeV]","nleps==1&&ht>500&&met>200&&njets>=6&&nbm>=1"));
  vars.back().whichPlots = "12"; vars.back().normalize = true;
  ...
  plot_distributions(Samples, vars, luminosity, plot_type, plot_style, "dec11",true);

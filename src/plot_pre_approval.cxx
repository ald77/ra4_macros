...
int main(){ 
  ...
  Samples.push_back(sfeats(s_slep, "Data 1l, N_{jets} #geq 6, m_{T} #leq 140, N_{b} #geq 1", dps::c_tt_1l,1,
    "(trig[4]||trig[8])&&pass&&mt<=140&&njets>=6&&nleps==1&&nbm>=1")); 
  ...
  plot_distributions(Samples, vars, luminosity, plot_type, plot_style, "1d_nov30",true);

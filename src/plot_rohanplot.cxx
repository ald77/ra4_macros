...
int main(){ 
  ...
  Samples.push_back(sfeats(s_tt, "t#bar{t}, 2 true leptons: m_{T} > 140 GeV", kViolet+9,25, "mt>140&&ntruleps==2&&stitch")); Samples.back().isData = true;
  Samples.push_back(sfeats(s_tt, "t#bar{t}, 1 true lepton: m_{T} > 140 GeV", kViolet+9,25,"mt>140&&ntruleps==1&&stitch")); Samples.back().isData = true;

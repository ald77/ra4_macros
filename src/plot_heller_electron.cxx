...
vars.push_back(hfeats("tks_mt",30,0,300, ra4_tt2l_t1, "track m_{T} (GeV), electron tracks, abs chg+neu iso mini < 20",
			     "ht>500&&mj>500&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&((tks_pt)*(tks_mini_ne+tks_mini_ch))<20"));

 vars.push_back(hfeats("tks_mt",30,0,300, ra4_tt2l_t1, "track m_{T} (GeV), electron tracks, abs chg+neu iso mini < 20",
			     "ht>500&&mj>300&&met>400&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&((tks_pt)*(tks_mini_ne+tks_mini_ch))<20"));


     
       vars.push_back(hfeats("(tks_pt)*(tks_mini_ne+tks_mini_ch)",40,0,200, ra4_tt2l_t1, "abs chg+neu mini isolation, electron tracks",
       ...
       vars.push_back(hfeats("(tks_pt)*(tks_mini_ne+tks_mini_ch)",40,0,200, ra4_tt_t1, "abs chg+neu mini isolation, electron tracks",
			     "ht>500&&mj>300&&met>400&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
    ...
    vars.push_back(hfeats("tks_mt",30,0,300, ra4_tt_t1, "track m_{T} (GeV), electron tracks, abs chg+neu mini iso < 10",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&((tks_pt)*(tks_mini_ne+tks_mini_ch))<10"));
    vars.push_back(hfeats("tks_mt",30,0,300, ra4_tt_t1, "track m_{T} (GeV), electron tracks, abs chg+neu iso mini < 20",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&((tks_pt)*(tks_mini_ne+tks_mini_ch))<20"));

    vars.push_back(hfeats("tks_mt",30,0,300, ra4_tt2l_t1, "track m_{T} (GeV), electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
 
    vars.push_back(hfeats("tks_pt",30,0,150, ra4_tt2l_t1, "track p_{T} (GeV), electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
    vars.push_back(hfeats("tks_pt",30,0,150, ra4_tt_t1, "track p_{T} (GeV), electron tracks, chg+neu iso < 0.2",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&(tks_mini_ne+tks_mini_ch)<0.2"));
    vars.push_back(hfeats("tks_pt",30,0,150, ra4_tt_t1, "track p_{T} (GeV), electron tracks, chg+neu iso < 1.0",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w&&(tks_mini_ne+tks_mini_ch)<1.0"));
     ...
     vars.push_back(hfeats("(tks_pt)*(tks_mini_ne+tks_mini_ch)",40,0,200, ra4_tt_t1, "abs chg+neu mini isolation, electron tracks",
       ...
       vars.push_back(hfeats("(tks_pt)*(tks_mini_ch)",40,0,200, ra4_tt_t1, "abs chg mini isolation, electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
       ...
       vars.push_back(hfeats("tks_mini_ne+tks_mini_ch",60,0,6, ra4_tt_t1, "chg+neu mini isolation, electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
       ...
       vars.push_back(hfeats("tks_mini_ne+tks_mini_ch",60,0,6, ra4_tt_t1, "chg+neu mini isolation, hadronic tracks truth-matched",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&!(tks_id*tks_id==121||tks_id*tks_id==169)&&tks_from_w&&tks_from_tauhad"));

       vars.push_back(hfeats("tks_mini_ne+tks_mini_ch",60,0,6, ra4_tt_t1, "chg+neu mini isolation, hadronic tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&!(tks_id*tks_id==121||tks_id*tks_id==169)&&!tks_from_w&&!tks_from_tauhad"));

																										      */
       vars.push_back(hfeats("tks_mini_ch",60,0,6, ra4_tt_t1, "chg mini isolation, electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&tks_from_w"));
       vars.push_back(hfeats("tks_mini_ch",60,0,6, ra4_tt_t1, "chg mini isolation, electron tracks",
			     "ht>500&&mj>300&&met>200&&nbm>=1&&mt>140&&njets>=6&&(nmus+nels)==1&&((tks_id*lep_charge)>0)&&(!tks_is_primary)&&tks_id*tks_id==121&&!tks_from_w"));
  ...
  //if(vars[var].title.Contains("muon") || vars[var].title.Contains("hadronic")) continue;
    ...
    can.SetLogy(0);
    pname = "plots/1d6/lumi_"+vars[var].tag+".pdf";
    can.SaveAs(pname);
	...
	cout<<Samples[isam].label<<" track isolation efficiency"<<endl<<Form("0.2: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(0.19)))<<"%"<<endl;
	cout<<Form("0.3: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(0.29)))<<"%"<<endl;
	cout<<Form("0.5: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(0.49)))<<"%"<<endl;
	cout<<Form("1.0: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(0.99)))<<"%"<<endl;
	cout<<Form("1.5: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(1.49)))<<"%"<<endl<<endl;
      	
    }

      if(vars[var].title.Contains("mini") && vars[var].title.Contains("abs") && sam !=1){
	
	cout<<Samples[isam].label<<" track isolation efficiency"<<endl<<Form("5: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(4.9)))<<"%"<<endl;
	cout<<Form("10: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(9.9)))<<"%"<<endl;
	cout<<Form("20: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(19.9)))<<"%"<<endl;
	cout<<Form("30: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(29.9)))<<"%"<<endl;
	cout<<Form("40: %.f",histo[1][var][sam]->Integral(histo[1][var][sam]->FindBin(0),histo[1][var][sam]->FindBin(39.9)))<<"%"<<endl<<endl;
    ...
    can.SetLogy(0);
    pname = "plots/1d6/shapes_"+vars[var].tag+".pdf";
    can.SaveAs(pname);
    histo[1][var][0]->SetMaximum(maxhisto*maxLog);
    can.SetLogy(1);
    pname = "plots/1d6/log_shapes_"+vars[var].tag+".pdf";
    //can.SaveAs(pname);
  }// Loop over variables
